...
export type blogsOptionalAttributes =
  | "id"
  | "cover"
  | "tags"
  | "meta_title"
  ...
  | "is_published"
  | "created_at";
export type blogsCreationAttributes = Optional<
  blogsAttributes,
  blogsOptionalAttributes
>;

export class blogs
  extends Model<blogsAttributes, blogsCreationAttributes>
