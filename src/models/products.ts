  ...
  implements productsAttributes
{
  ...
  setProducts_embeddings!: Sequelize.HasManySetAssociationsMixin<
    products_embedding,
    products_embeddingId
  >;
  addProducts_embedding!: Sequelize.HasManyAddAssociationMixin<
    products_embedding,
    products_embeddingId
  >;
  addProducts_embeddings!: Sequelize.HasManyAddAssociationsMixin<
    products_embedding,
    products_embeddingId
  >;
  createProducts_embedding!: Sequelize.HasManyCreateAssociationMixin<products_embedding>;
  removeProducts_embedding!: Sequelize.HasManyRemoveAssociationMixin<
    products_embedding,
    products_embeddingId
  >;
  removeProducts_embeddings!: Sequelize.HasManyRemoveAssociationsMixin<
    products_embedding,
    products_embeddingId
  >;
  hasProducts_embedding!: Sequelize.HasManyHasAssociationMixin<
    products_embedding,
    products_embeddingId
  >;
  hasProducts_embeddings!: Sequelize.HasManyHasAssociationsMixin<
    products_embedding,
    products_embeddingId
  >;
  ...
  setProducts_variants!: Sequelize.HasManySetAssociationsMixin<
    products_variants,
    products_variantsId
  >;
  addProducts_variant!: Sequelize.HasManyAddAssociationMixin<
    products_variants,
    products_variantsId
  >;
  addProducts_variants!: Sequelize.HasManyAddAssociationsMixin<
    products_variants,
    products_variantsId
  >;
  createProducts_variant!: Sequelize.HasManyCreateAssociationMixin<products_variants>;
  removeProducts_variant!: Sequelize.HasManyRemoveAssociationMixin<
    products_variants,
    products_variantsId
  >;
  removeProducts_variants!: Sequelize.HasManyRemoveAssociationsMixin<
    products_variants,
    products_variantsId
  >;
  hasProducts_variant!: Sequelize.HasManyHasAssociationMixin<
    products_variants,
    products_variantsId
  >;
  hasProducts_variants!: Sequelize.HasManyHasAssociationsMixin<
    products_variants,
    products_variantsId
  >;
